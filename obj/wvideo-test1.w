...
DEFINE FRAME fMain
     BUTTON-4 AT ROW 14.54 COL 49.33 WIDGET-ID 4
...
/* CtrlFrame OCXINFO:CREATE-CONTROL from: {D27CDB6E-AE6D-11cf-96B8-444553540000} type: ShockwaveFlash */
      CtrlFrame:MOVE-BEFORE(BUTTON-4:HANDLE IN FRAME fMain).
...
DO:
    chCtrlFrame:ShockwaveFlash:playing = true. 
END.
...
OCXFile = SEARCH( "wvideo-test1.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "wvideo-test1.wrx":U SKIP(1)
