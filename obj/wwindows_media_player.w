...
&Scoped-Define ENABLED-OBJECTS BtnPause BtnPlay btnStop BtnAssignPosition 
...
DEFINE FRAME fMain
     BtnPause AT ROW 10.54 COL 33.67 WIDGET-ID 8
     BtnPlay AT ROW 10.58 COL 3.17 WIDGET-ID 4
     btnStop AT ROW 10.58 COL 18.33 WIDGET-ID 6
...
/* CtrlFrame-4 OCXINFO:CREATE-CONTROL from: {F0B88A90-F5DA-11CF-B545-0020AF6ED35A} type: PSTimer */
      CtrlFrame:MOVE-BEFORE(BtnPause:HANDLE IN FRAME fMain).
...
------------------------------------------------------------------------------*/
  ENABLE BtnPause BtnPlay btnStop BtnAssignPosition 
