...
DEFINE FRAME fMain
     BUTTON-3 AT ROW 15.38 COL 45.67 WIDGET-ID 4
...
/* CtrlFrame OCXINFO:CREATE-CONTROL from: {8856F961-340A-11D0-A96B-00C04FD705A2} type: WebBrowser */
      CtrlFrame:MOVE-BEFORE(BUTTON-3:HANDLE IN FRAME fMain).
...
DO:
  ...
  chCtrlFrame:WebBrowser:Navigate ("https://www.youtube.com/watch?v=SECoADTJ5ik&t=1188s"). 
...
OCXFile = SEARCH( "wvideo-test.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "wvideo-test.wrx":U SKIP(1)
